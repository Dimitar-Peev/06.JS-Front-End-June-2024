function solve() {
    ...
    function onClick() {
        ...
        function print(sorted) {
            bestRestaurantOutput.textContent = `Name: ${restaurant[0]} Average Salary: ${restaurant[1].toFixed(2)} Best Salary: ${calcHighestSalary().toFixed(2)}`;
            sorted.forEach(([name, salary]) =>
